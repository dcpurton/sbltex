...
alternative can be specified by passing options to the \textsf{sblfonts}
package using the \texttt{sblfonts} class option. See the documentation for
the \textsf{sblfonts} package for details.
...
\nocite{NIDNTT, Jastrow, DMBI, mclay:2006, oday:intertextuality, vonrad:1990}
